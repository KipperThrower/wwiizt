...
public class FeatureService {
	...
	public Set<Integer> selectFeatures(String path) {
		Integer[] f= new Integer[] {2,9,10,13,14,15,49,591,1225,1226,1230,1383,2019,4279,5223,5415,5647,8240,8483,8802,9393,9406,9437,9673,10078,10100,11573,11717,11801,11851,13556,13712,13802,13848,13909,14023,14228,14547,14717,15201,15320,16038,16245,16472,16581,16732,17575,17836,18361,18466,18976,19160,19366,19565,19939,20363,20794,21229,21253,21783,22160,22279,22669,23138,23185,23192,23403,24181,24691,25047,25503,26213,26227,26939,27087,27088,27091,27092};
...
//		}
	...
	public void rewriteSelectedFeatures(String path, List<String> bigrams) {
		...
		try {
			...
			fw1 = new FileWriter(path + "_selected.arff");
			int j = 1;
